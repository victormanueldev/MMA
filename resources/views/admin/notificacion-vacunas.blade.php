...
<div class="row page-titles">
	<div class="col-md-5 col-8 align-self-center">
		<h3 class="text-themecolor m-b-0 m-t-0">Notificaciones de Vacunas</h3>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="javascript:void(0)">Panel</a></li>
			<li class="breadcrumb-item active">Notificaciones de Vacunas</li>
		</ol>
	</div>
	<div class="">
            ...
            <div class="chat-main-box">
                ...
                <div class="chat-right-aside">
                    ...
                    <div class="card-body b-t">
                        <div class="row">
                            <div class="col-8">
                               {!! Form::open(['route' => ['sms-vacuna'], 'method' => 'POST']) !!}
            ...
            <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">¿Está seguro que desea enviar el SMS Masivo?
